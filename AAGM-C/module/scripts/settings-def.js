// Settings definitions shared by module and relay.

const MODULE_ID = 'foundry-bridge';

export const SETTING_KEYS = [
  'mode', 'multitasking', 'chainOffers', 'chainOfferThreshold', 'chainMaxLength',
  'mirrorEnabled', 'mirrorPath', 'mirrorContextualSort', 'writePolicy',
];
...
const DEFS = {
  ...
  writePolicy:          { type: String,  default: 'rollback' }, /* mode independent, presets skip it */
};
