...
const L = (k) => game.i18n.localize(`AAGM_K.SETTINGS.${k}`);
...
export class AagmSettingsMenu extends FormApplication {
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      id: 'aagm-settings',
      title: game.i18n.localize('AAGM_K.SETTINGS.MenuTitle'),
  ...
  async _updateObject(_event, formData) {
    ...
    ui.notifications?.info(game.i18n.localize('AAGM_K.SETTINGS.Saved'));
  }
}
